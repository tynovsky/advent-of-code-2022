...
occupied_space = dirs["/"]["total_size"]
unused_space = total_disk_space - occupied_space

need_to_free_up = space_needed - unused_space

print(need_to_free_up)

candidate = "/"
for d in dirs:
    if dirs[d]["total_size"] < need_to_free_up:
        continue
    if dirs[d]["total_size"] < dirs[candidate]["total_size"]:
        candidate = d

print(candidate)
print(dirs[candidate]["total_size"])
